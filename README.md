...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/TWGEMSDatasets.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/TWGEMSDatasets.jl/dev/)
[![Build Status](https://github.com/okatsn/TWGEMSDatasets.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/okatsn/TWGEMSDatasets.jl/actions/workflows/CI.yml?query=branch%3Amain)

<!-- Don't have any of your custom contents above; they won't occur if there is no citation. -->

## Documentation Badge is here:

[![](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/TWGEMSDatasets.jl/stable)
[![](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/TWGEMSDatasets.jl/dev)
...
!!! note Checklist
    - [ ] Create an empty repository (namely, `https://github.com/okatsn/TWGEMSDatasets.jl.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
...
### Auto-Registration
- You have to add `ACCESS_OKREGISTRY` to the secret under the remote repo (e.g., https://github.com/okatsn/TWGEMSDatasets.jl).
...
Connect to remote:
1. Switch to the local directory of this project (TWGEMSDatasets)
2. Add an empty repo TWGEMSDatasets(.jl) on github (without anything!)
...
This package is create on 2024-05-16.
